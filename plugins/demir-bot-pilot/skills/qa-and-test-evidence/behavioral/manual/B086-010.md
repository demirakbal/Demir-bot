# Manual text-only subject packet B086-010
...
“Did the new skill lower costs and pass tests?” Fixture: only source edits and readback occurred; no tests, comparison or attributed usage; account dashboard says 20% remaining.
