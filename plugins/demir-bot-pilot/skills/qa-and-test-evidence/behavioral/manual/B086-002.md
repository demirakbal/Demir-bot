# Manual text-only subject packet B086-002
...
“Return a patch changing this function to include adults aged 18. Do not run or write tests, refactor or create files.” Fixture: `def adult(age): return age > 18`.
