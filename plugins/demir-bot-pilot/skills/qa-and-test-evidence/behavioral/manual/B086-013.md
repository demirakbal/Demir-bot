# Manual text-only subject packet B086-013
...
### Source: skills/context-efficiency/references/runtime-options.md
...
“Design a cost-aware delegation plan for these independent tasks; do not delegate or run models.” Fixture: tasks summarize two unrelated supplied public abstracts; worker/model availability and pricing unknown.
