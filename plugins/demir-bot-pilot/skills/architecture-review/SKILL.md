...
description: Review or design software architecture using requirements, repository evidence and explicit trade-offs. Use for system design, module boundaries, dependency cycles, data flow, architectural risks and significant structural decisions. Skip routine small fixes; a review does not authorize implementation.
---
